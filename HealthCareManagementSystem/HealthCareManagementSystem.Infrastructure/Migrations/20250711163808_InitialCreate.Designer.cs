...
namespace HealthCareManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20250711163808_InitialCreate")]
            ...
            modelBuilder.Entity("HealthCareManagementSystem.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppointmentId = 1,
                            AppointmentDate = new DateTime(2025, 7, 11, 0, 0, 0, 0, DateTimeKind.Utc),
                            DoctorId = "D001",
                            PatientId = "P001",
            ...
            modelBuilder.Entity("HealthCareManagementSystem.Domain.Entities.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecordDate = new DateTime(2025, 7, 11, 16, 38, 7, 971, DateTimeKind.Utc).AddTicks(4050)
                        });
                });
            ...
            modelBuilder.Entity("HealthCareManagementSystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "admin001",
                            CreatedAt = new DateTime(2025, 7, 11, 16, 38, 7, 970, DateTimeKind.Utc).AddTicks(9380),
                            Password = "admin@123",
                            Role = "Admin"
                        });
                });
